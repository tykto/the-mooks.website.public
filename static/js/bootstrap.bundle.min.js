...
!(function (t, e) {
  ...
  function Ut(t, e, n, i) {
    return Math.max(
      ...
      n['scroll' + t],
      Ht(10)
        ? parseInt(n['offset' + t]) + parseInt(i['margin' + ('Height' === t ? 'Top' : 'Left')]) + parseInt(i['margin' + ('Height' === t ? 'Bottom' : 'Right')])
        : 0
    );
  }
  function Bt(t) {
          ...
          if (!t || (3 !== t.which && ('keyup' !== t.type || 9 === t.which)))
            for (var e = [].slice.call(document.querySelectorAll(je)), n = 0, i = e.length; n < i; n++) {
              ...
              if ((t && 'click' === t.type && (s.clickEvent = t), r)) {
                ...
                if (
                  p(o).hasClass(Ne) &&
                  !(t && (('click' === t.type && /input|textarea/i.test(t.target.tagName)) || ('keyup' === t.type && 9 === t.which)) && p.contains(o, t.target))
                ) {
    ...
    Wi = (function () {
      ...
      return (
        (t.show = function () {
          ...
          if (
            !(
              (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Oi)) ||
